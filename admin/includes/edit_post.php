...
<div class="form-group">
<select class="form-control me-1" name="post_category" id="">
<?php  
...
<div class="form-group">
        ...
        <div class="form-group">
        <select class="form-control me-1" name="post_status" id="">
